...
/**
 * Simple on-device screenshot comparator that uses golden images present in `androidTest/assets`.
 * It's used to showcase the [AnimationClockTestRule] used in [AnimationCircleTests].
 *
