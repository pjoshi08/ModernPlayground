...
import com.example.modernplayground.data.MADRID
...
class DetailsActivityTest {
     ...
     *
     * As obtaining the map is an asynchronous call, we use a CountDownLatch to make this call
     * synchronous in the test.
     */
