...
import com.example.modernplayground.ui.components.AnimatedCircle
import com.example.modernplayground.ui.theme.RallyTheme
import org.junit.Rule
import org.junit.Test

/**
 * Test to showcase [MainTestClock] present in [ComposeTestRule]. It allows for animation testing
 * at specific moments in time.
 *
 * For assertions, a simple screenshot testing framework is used. It requires SDK 26+ and to be
 * run on a device with 420dpi, as that is the density used to generate the golden images present
 * in androidTest/assets. It runs bitmap comparisons on device.
 *
