...
import com.example.modernplayground.util.LoadingContent
import com.example.modernplayground.util.StatisticsTopAppBar
    ...
    LoadingContent(
        ...
        Column(
            ...
            if (!loading) {
                ...
                Text(
                    stringResource(id = R.string.statistics_completed_tasks, completedTasksPercent)
                )
            }
        }
    }
