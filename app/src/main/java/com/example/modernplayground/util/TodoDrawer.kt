...
import com.example.modernplayground.TodoDestinations
import com.example.modernplayground.TodoNavigationActions
...
private fun AppDrawer(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        DrawerHeader()
        DrawerButton(painter = painterResource(id = R.drawable.ic_list),
        ...
        DrawerButton(painter = painterResource(id = R.drawable.ic_statistics),
